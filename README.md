...
- [Azure Quantum Development Kit](https://marketplace.visualstudio.com/items?itemName=quantum.qsharp-lang-vscode)
...
- [Microsoft MakeCode Arcade](https://marketplace.visualstudio.com/items?itemName=ms-edu.pxt-vscode-web)
